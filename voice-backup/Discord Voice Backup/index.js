...
function bindConnectionInstance(instance) {
  return {
    ...
    destroyUser: (odid) => instance.destroyUser(odid),

    setLocalVolume: (userId, volume) => instance.setLocalVolume(userId, volume),
    setLocalMute: (odid, mute) => instance.setLocalMute(odid, mute),
    setLocalPan: (userId, pan, mono) => instance.setLocalPan(userId, pan, mono),
    setDisableLocalVideo: (odid, disabled) => instance.setDisableLocalVideo(odid, disabled),
    ...
    setRemoteUserSpeakingStatus: (odid, odidsSpeaking) => instance.setRemoteUserSpeakingStatus(odid, odidsSpeaking),
    setRemoteUserCanHavePriority: (odid, odidsCanHavePriority) =>
      instance.setRemoteUserCanHavePriority(odid, odidsCanHavePriority),
    ...
    setDesktopSource: (id, videoSource, useVideoHook, useGraphicsCapture, useQuartzCapturer, allowScreenCaptureKit, hdrEnabled) =>
      instance.setDesktopSource(id, videoSource, useVideoHook, useGraphicsCapture, useQuartzCapturer, allowScreenCaptureKit, hdrEnabled),
    ...
    clearDesktopSourceWithOptions: (options) => instance.clearDesktopSourceWithOptions(options),
    ...
    startSamplesPlayback: (samplesId, options, channels, callback) =>
      instance.startSamplesPlayback(samplesId, options, channels, callback),
    stopSamplesPlayback: (samplesId) => instance.stopSamplesPlayback(samplesId),
    stopAllSamplesPlayback: () => instance.stopAllSamplesPlayback(),
    setNoiseCancellation: (enabled, attenuation) => instance.setNoiseCancellation(enabled, attenuation),
    setInputDevice: (id) => instance.setInputDevice(id),
    setOutputDevice: (id) => instance.setOutputDevice(id),
    setVideoInputDevice: (id) => instance.setVideoInputDevice(id),
    setVideoOutputDeviceRotation: (rotation) => instance.setVideoOutputDeviceRotation(rotation),
    setEchoCancellation: (enabled) => instance.setEchoCancellation(enabled),
    setNoiseSuppression: (enabled) => instance.setNoiseSuppression(enabled),
    setAutomaticGainControl: (enabled) => instance.setAutomaticGainControl(enabled),
    setQoS: (enabled) => instance.setQoS(enabled),
    setAttenuation: (enabled, attenuateFactor, attenuateWhileSpeakingSelf, attenuateWhileSpeakingOthers) =>
      instance.setAttenuation(enabled, attenuateFactor, attenuateWhileSpeakingSelf, attenuateWhileSpeakingOthers),
    setLocalVideoFlipped: (localVideoFlipped) => instance.setLocalVideoFlipped(localVideoFlipped),
    setNetworkOverhead: (overhead) => instance.setNetworkOverhead(overhead),
    getNetworkOverhead: (callback) => instance.getNetworkOverhead(callback),
    getBitRate: (callback) => instance.getBitRate(callback),
    setGoLiveSource: (options) => instance.setGoLiveSource(options),
    clearGoLiveSource: (options) => instance.clearGoLiveSource(options),
    setScreenPreview: (outputId, options) => instance.setScreenPreview(outputId, options),
    setWindowPreview: (outputId, options) => instance.setWindowPreview(outputId, options),
    clearScreenPreview: (outputId) => instance.clearScreenPreview(outputId),
    clearWindowPreview: (outputId) => instance.clearWindowPreview(outputId),
    setClipsSource: (options, callback) => instance.setClipsSource(options, callback),
    clearClipsSource: (options) => instance.clearClipsSource(options),
    forceResetClips: () => instance.forceResetClips(),
    getClipsMetadata: () => instance.getClipsMetadata(),
    setClipsEnabled: (enabled) => instance.setClipsEnabled(enabled),
    setSaveClipsDirectory: (directory) => instance.setSaveClipsDirectory(directory),
    startClipsBookmark: (bookmark) => instance.startClipsBookmark(bookmark),
    updateClipsBookmark: (bookmark) => instance.updateClipsBookmark(bookmark),
    saveClip: (clip, callback) => instance.saveClip(clip, callback),
    exportClip: (clip, callback) => instance.exportClip(clip, callback),
    getClipFormats: (callback) => instance.getClipFormats(callback),
    setVoiceActivityThreshold: (threshold) => instance.setVoiceActivityThreshold(threshold),
    setSilenceThreshold: (threshold) => instance.setSilenceThreshold(threshold),
    setExperimentConfig: (config) => instance.setExperimentConfig(config),
