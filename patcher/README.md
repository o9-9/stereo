...
# ⚠️ Historical note: related projects now live in the [Discord Stereo monorepo](https://github.com/o9-9/stereo/tree/main/packages/system) (`packages/system`).
...
[**📥 Download Stereo-Node-Patcher-Windows.BAT**](https://github.com/o9-9/stereo/raw/main/packages/node-patcher/Stereo-Node-Patcher-Windows.BAT) · [Releases](https://github.com/o9-9/stereo/releases)
...
```powershell
$ProgressPreference='SilentlyContinue'; $p = Join-Path $env:TEMP 'dvp.ps1'; $u = "https://raw.githubusercontent.com/o9-9/stereo/main/packages/node-patcher/Discord_voice_node_patcher.ps1?nocache=$([DateTime]::UtcNow.Ticks)"; Invoke-WebRequest -Uri $u -OutFile $p; powershell -NoProfile -ExecutionPolicy Bypass -File $p
```

#### Command Prompt (cmd.exe)

```bat
powershell -NoProfile -ExecutionPolicy Bypass -Command "$ProgressPreference='SilentlyContinue'; $p = Join-Path $env:TEMP 'dvp.ps1'; $u = 'https://raw.githubusercontent.com/o9-9/stereo/main/packages/node-patcher/Discord_voice_node_patcher.ps1?nocache=' + [DateTime]::UtcNow.Ticks; Invoke-WebRequest -Uri $u -OutFile $p; & $p"
```
...
- **CHANGED:** Repository moved to [Discord-Node-Patcher](https://github.com/o9-9/stereo/tree/main/packages/node-patcher)
...
[View full changelog →](https://github.com/o9-9/stereo/releases)
...
**[Report Issue](https://github.com/o9-9/stereo/issues)** · **[Releases](https://github.com/o9-9/stereo/releases)** · **[Source Code](https://github.com/o9-9/stereo/tree/main/packages/node-patcher)**
