# What `DiscordVoiceFixer.ps1` does
...
## If you run it with no switches (normal double-click or `.\DiscordVoiceFixer.ps1`)
...
## URLs that may be downloaded (or fetched) when `DiscordVoiceFixer.ps1` runs
