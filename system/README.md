...
[![Windows](https://img.shields.io/badge/Windows-Active-00C853?style=flat-square)](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Windows)
[![macOS](https://img.shields.io/badge/macOS-Active-00C853?style=flat-square)](https://codeberg.org/DiscordStereoPatcher-macOS)
[![Linux](https://img.shields.io/badge/Linux-Active-00C853?style=flat-square)](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Linux)
...
| 🔗 **Latest scripts**  | **[`Updates/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates)** on `main` (what launchers fetch) |
...
1. Grab [`Stereo Installer.bat`](https://github.com/o9-9/stereo/raw/main/packages/system/Updates/Windows/Stereo%20Installer.bat) from [`Updates/Windows/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Windows).
...
The `.bat` pulls [`DiscordVoiceFixer.ps1`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/DiscordVoiceFixer.ps1) from `main`. Running as Administrator avoids permission issues under `%LOCALAPPDATA%\Discord\`.
...
**Start here on Linux.** [`discord-stereo-launcher.sh`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Linux/discord-stereo-launcher.sh) downloads **`discord_voice_patcher_linux.sh`**, **`Stereo-Installer-Linux.sh`**, and **`Discord_Stereo_Installer_For_Linux.py`** into **`Linux Stereo Installer/`** next to the launcher, then opens a **GUI** where you **choose installer vs patcher mode**. The UI **warns that installer mode is still a placeholder** (pre-built bundles) — **use patcher mode** for a working path today.
...
2. Download **[`discord-stereo-launcher.sh`](https://github.com/o9-9/stereo/raw/main/packages/system/Updates/Linux/discord-stereo-launcher.sh)** from [`Updates/Linux/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Linux).
...
Use [`discord_voice_patcher_linux.sh`](https://github.com/o9-9/stereo/raw/main/packages/system/Updates/Linux/Updates/discord_voice_patcher_linux.sh) from [`Updates/Linux/Updates/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Linux/Updates) if you prefer the terminal only: install **`g++`**, `chmod +x`, run **`./discord_voice_patcher_linux.sh --help`**.
...
1. Download [`Stereo-Node-Patcher-Windows.BAT`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/Stereo-Node-Patcher-Windows.BAT) from [`Updates/Windows/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Windows) (it fetches [`Discord_voice_node_patcher.ps1`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/Discord_voice_node_patcher.ps1) from `main`).
...
| Path                                                                                                         | Contents                                                                                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`Updates/Windows/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Windows)               | Voice Fixer, Advanced Windows patching (`.BAT` + PS1)                                                                                                                                                                        |
| [`Updates/Linux/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Linux)                   | **[`discord-stereo-launcher.sh`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Linux/discord-stereo-launcher.sh)** (main entry — GUI mode picker); `Updates/Linux/Updates/` — patcher + installer scripts |
| [`Updates/Offset Finder/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Offset%20Finder) | Offset finder CLI and GUI                                                                                                                                                                                                    |
| [`Updates/Nodes/`](https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Nodes)                   | Reference nodes for patchers                                                                                                                                                                                                 |

[`Voice Node Dump/`](https://github.com/o9-9/stereo/tree/main/packages/system/Voice%20Node%20Dump) — archived modules for research (optional for end users).
...
**Voice Fixer** ([`Stereo Installer.bat`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/Stereo%20Installer.bat) → [`DiscordVoiceFixer.ps1`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/DiscordVoiceFixer.ps1)) installs **pre-patched** `discord_voice.node` files. **No compiler.**

**Advanced Windows patching** ([`Stereo-Node-Patcher-Windows.BAT`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/Stereo-Node-Patcher-Windows.BAT) → [`Discord_voice_node_patcher.ps1`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Windows/Discord_voice_node_patcher.ps1)) builds the patcher on your machine and edits the binary. **Needs a C++ compiler.** Use when Voice Fixer isn’t enough — new Discord build, custom offsets, or you want full control.
...
After Discord rebases the module, run [`discord_voice_node_offset_finder_v5.py`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Offset%20Finder/discord_voice_node_offset_finder_v5.py) or [`offset_finder_gui.py`](https://github.com/o9-9/stereo/blob/main/packages/system/Updates/Offset%20Finder/offset_finder_gui.py), then paste the generated offset block into the Windows / Linux patcher scripts. For **macOS**, follow the **Swift** patcher workflow on [Codeberg](https://codeberg.org/DiscordStereoPatcher-macOS).
...
[Shaun (sh6un)](https://github.com/sh6un) · [UnpackedX](https://codeberg.org/UnpackedX) · [Voice Playground](https://discord-voice.xyz/) · [Oracle](https://github.com/oracle-dsc) · [Loof-sys](https://github.com/LOOF-sys) · [Hallow](https://github.com/o9-9) · [Ascend](https://github.com/bloodybapestas) · BluesCat · [Sentry](https://github.com/sentry1000) · [Sikimzo](https://github.com/sikimzo) · [CRÜE](https://codeberg.org/DiscordStereoPatcher-macOS) · [HorrorPills / Geeko](https://github.com/HorrorPills)
