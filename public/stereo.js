 ...
 * @name stereo
 * @version 0.0.6
 * @description Adds stereo sound to Discord with some extra stuff.
 * @authorLink https://github.com/o9-9
 * @source https://github.com/o9-9/stereo/blob/main/files/stereo.js
 */
module.exports = (() => {
  const config = {
    ...
    info: {
      ...
      version: "0.0.6",
      description:
        "Adds stereo sound to your Discord Client with some extra stuff.",
    },
    changelog: [
      {
        title: "Changelog",
  ...
  return !global.SPL
    ? class {
        ...
        load() {
          BdApi.showConfirmationModal(
            "[stereo] Library Missing",
            `SPL is missing. Click "Install Now" to download it.`,
            {
              ...
              onConfirm: () => {
                require("request").get(
                  ...
                  async (error, response, body) => {
                    if (error) {
                      console.error("Error downloading SPL:", error);
                      BdApi.showConfirmationModal(
                        "Download Error",
                        "An error occurred while downloading SPL. Please try again later or download it manually from the official website.",
                        {
                          confirmText: "OK",
                          cancelText: "Cancel",
                        },
    ...
    : (([Plugin, Api]) => {
        const plugin = (Plugin, Library) => {
          ...
          return class stereo extends Plugin {
            onStart() {
              BdApi.UI.showNotice(
                "[stereo v.0.0.1] You can now use stereo 😉",
                ...
                (thisObj, _args, ret) => {
                  if (thisObj) {
                    ...
                    thisObj.conn.setTransportOptions = (obj) => {
                      ...
                      if (!this.justJoined) {
                        const spotifyStatus = this.settings.otherSettings
                          .enableSpotifyPauseBlocker
                          ? "Enabled"
                          : "Disabled";
                        this.showCustomToast(
                          `stereo: Channel ${channelOption}, Bitrate ${parseInt(selectedBitrate) / 1000}kbps, Spotify Blocker: ${spotifyStatus}`,
                          { type: "info", timeout: 5000 },
                        );
              ...
              this.showCustomToast = (content, options) => {
                // added
              ...
              const voiceConnectionModule = WebpackModules.getByProps(
                "hasVideo",
                "disconnect",
                "isConnected",
              );
              this.disconnectPatcher = BdApi.Patcher.after(
                "stereo",
                voiceConnectionModule,
                "disconnect",
                () => {
                  this.justJoined = false;
                },
            ...
            enableSpotifyPauseBlocker() {
              ...
              this.showCustomToast("stereo: Spotify Pause Blocker Enabled", {
                type: "success",
                timeout: 6000,
              });
            }
            ...
            disableSpotifyPauseBlocker() {
              ...
              this.showCustomToast("stereo: Spotify Pause Blocker Disabled", {
                type: "warning",
                timeout: 6000,
              });
            }
            ...
            settingsWarning() {
              ...
              if (
                ...
                if (this.settings.enableToasts) {
                  Toasts.show(
                    "Please disable echo cancellation, noise reduction, and noise suppression for optimal stereo performance",
            ...
            getSettingsPanel() {
              ...
              noteElement.className = "stereo-settings-note";
