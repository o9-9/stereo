...
# Payloads: https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Linux/Updates
...
REPO_RAW_LINUX_UPDATES="https://raw.githubusercontent.com/o9-9/stereo/main/packages/system/Updates/Linux/Updates"
...
if ! command -v python3 >/dev/null 2>&1; then
    ...
    echo -e "  (or equivalent for your system)"
    exit 1
fi
