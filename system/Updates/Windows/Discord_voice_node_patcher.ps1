...
$Script:UPDATE_URL_BASE = "https://raw.githubusercontent.com/o9-9/stereo/main/packages/system/Updates/Windows/Discord_voice_node_patcher.ps1"
...
$Script:Config = @{
    ...
    MaxBackupAgeDays      = 45
    # Browser (same folder as VoiceBackupAPI): https://github.com/o9-9/stereo/tree/main/packages/system/Updates/Nodes/Unpatched%20Nodes%20(For%20Patcher)/Windows
